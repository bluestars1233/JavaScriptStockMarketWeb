...
<ul>
  ...
  <li><a href="search.html">Search price</a></li>
...
<h4>Please help us to make ,so that we can offer you best experience at our web site!</br>Happy investing
</h4>
...
$bug = $conn->real_escape_string($_POST['bug']);
$query   = "INSERT into reportbug (u_name,u_email,contact,bug) VALUES('" . $name . "','" . $email . "','" . $contact . "','" . $bug . "')";
...
echo "Thank You For sharing your problem with our site . Our technical team will look over it very soon and contact you for your problem! <br>";
}
$conn->close();
