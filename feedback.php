...
<ul>
  ...
  <li><a href="tem.html">New Account</a></li>
...
Feedback:<br>
  <input type="text" name="feed" required><br>
...
$query   = "INSERT into feedback (u_name,u_email,contact,feed) VALUES('" . $name . "','" . $email . "','" . $contact . "','" . $feed . "')";
