...
<h3>Buy new units in mutual fund </h3>
...
<div class="container">
  <form action="" method="post">
    ...
    <input type="text" id="lname" name="uname" placeholder="Your user name..">
		...
		<input type="text" id="company" name="company" placeholder=" NAME OF THE SCHEME THAT YOU WANT TO TRADE..">

    <label for="exchange">scheme</label>
    <select id="exchange" name="exchange">
      <option value="BSE">RELINACE MF</option>
      <option value="NSE">DSP BLACKROCK</option>

	      <option value="BSE">ADITYA BIRLA CAPITAL MF</option>
	      <option value="NSE">HDFC MF</option>

					<option value="BSE">KOTAK MAHINDRA MF</option>
					<option value="NSE">SBI EASY MF</option>
